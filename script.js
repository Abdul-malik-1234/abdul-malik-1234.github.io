...
function findassigneduser(group,user,data,i){
    ...
    if(data.records[i].assignment_group==="36e37ae36fe755008e4c4f654b3ee421"){
        ...
        else if(user==="79352f242bdc66506b06f629fe91bfb0") return [group,"Mohan Nagaraju (9507571)"];
        ...
        else it(user==="7116d8211bc3d5d06e79311d1e4bcb3f") return [group,"Rosario Lawrence (9505828)"]; 
